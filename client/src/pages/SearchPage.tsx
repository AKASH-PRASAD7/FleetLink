...
import { VehicleSearch as SearchParams, AvailableVehicle, InsertBooking } from "@shared/schema";
...
export default function SearchPage() {
  ...
  const [selectedVehicle, setSelectedVehicle] = useState<AvailableVehicle | undefined>();
  ...
  const handleSearch = async (params: SearchParams) => {
    ...
    try {
      ...
      const response = await fetch(`/api/vehicles/available?${queryParams}`);
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Find available vehicles for your logistics needs and book them instantly.
        </p>
      </div>
